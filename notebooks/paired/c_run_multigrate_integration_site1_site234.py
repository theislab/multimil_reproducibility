...
def train(seed=None, split=None, run=None, config_name=None, **config):
    ...
    cite_query = ['site2_donor1_cite', 'site2_donor4_cite', 'site2_donor5_cite',
       'site3_donor1_cite', 'site3_donor6_cite', 'site3_donor7_cite']
    snrna_query = ['site2_donor1_multiome',
       'site2_donor4_multiome', 'site2_donor5_multiome']
    multiome_query = ['site3_donor3_multiome', 'site3_donor6_multiome',
       'site3_donor7_multiome', 'site3_donor10_multiome']
    atac_query = ['site4_donor1_multiome', 'site4_donor8_multiome',
