...
def train(seed=None, split=None, run=None, config_name=None, **config):
    ...
    #    name += '-noconddec'
    #if model_params.get("condition_encoders", False) is True:
    #    name += '-condenc'
    # add split counter
    ...
    scrna_query = ['site4_donor1_cite', 'site4_donor8_cite', 'site4_donor9_cite']
    cite_query = ['site3_donor1_cite', 'site3_donor6_cite', 'site3_donor7_cite']
    snrna_query = ['site3_donor3_multiome', 'site3_donor6_multiome']
    multiome_query = ['site3_donor7_multiome', 'site3_donor10_multiome', 'site4_donor1_multiome']
    atac_query = ['site4_donor8_multiome', 'site4_donor9_multiome']
